...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Data telah ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.halaman.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Data telah diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Berhasil mengapus');
    }
}
