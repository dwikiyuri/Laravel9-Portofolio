          ...
          <div class="col-lg">
            <div class="card">
              <div class="card-body">
                ...
                <a href="{{ route('halaman.create') }}" class="btn btn-dark mb-3">+Tambah Pengalaman</a>
                <!-- Default Table -->
                <table class="table">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('halaman.edit', $d->id) }}" class="btn btn-warning">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form id="delete-form-{{ $d->id }}" method="POST" action="{{ route('halaman.destroy', $d->id) }}" class="d-inline">
                                @csrf
                                @method('DELETE')
