        ...
        <div class="col-lg">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Horizontal Form -->
              <form action="{{ route('experience.update', $id) }}" method="POST" >
                @csrf
                @method('put')
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                      <input placeholder="Nama Perusahaan" type="text" value="{{ $info1 }}" class="form-control" id="inputInfo1" name="info1">
                    </div>
                  </div>
                  <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea type="text"  rows="5" class="form-control summernote" id="inputEmail" name="isi">{{ $isi }}</textarea>
                  </div>
                </div>
